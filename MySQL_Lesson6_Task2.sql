...
CREATE VIEW divorcedPerson 
AS SELECT birthday, phone FROM personalData
JOIN
person
ON personalData.id = person.id
WHERE personalData.familyStatus = 'Divorced';

SELECT * FROM divorcedPerson;


CREATE VIEW managers
AS SELECT birthday, phone FROM salary
INNER JOIN
personalData
